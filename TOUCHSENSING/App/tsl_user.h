...
#define CHANNEL_4_IO_MSK    (TSC_GROUP5_IO3)
...
#define CHANNEL_12_IO_MSK    (TSC_GROUP6_IO4)
...
#define BANK_0_NBCHANNELS (6)
#define BANK_0_MSK_CHANNELS   (CHANNEL_0_IO_MSK | CHANNEL_1_IO_MSK | CHANNEL_2_IO_MSK | CHANNEL_3_IO_MSK | CHANNEL_4_IO_MSK | CHANNEL_5_IO_MSK)
#define BANK_0_MSK_GROUPS     (CHANNEL_0_GRP_MSK | CHANNEL_1_GRP_MSK | CHANNEL_2_GRP_MSK | CHANNEL_3_GRP_MSK | CHANNEL_4_GRP_MSK | CHANNEL_5_GRP_MSK)

#define BANK_1_NBCHANNELS (4)
#define BANK_1_MSK_CHANNELS   (CHANNEL_6_IO_MSK | CHANNEL_7_IO_MSK | CHANNEL_8_IO_MSK | CHANNEL_9_IO_MSK)
#define BANK_1_MSK_GROUPS     (CHANNEL_6_GRP_MSK | CHANNEL_7_GRP_MSK | CHANNEL_8_GRP_MSK | CHANNEL_9_GRP_MSK)

#define BANK_2_NBCHANNELS (3)
#define BANK_2_MSK_CHANNELS   (CHANNEL_10_IO_MSK | CHANNEL_11_IO_MSK | CHANNEL_12_IO_MSK)
#define BANK_2_MSK_GROUPS     (CHANNEL_10_GRP_MSK | CHANNEL_11_GRP_MSK | CHANNEL_12_GRP_MSK)
