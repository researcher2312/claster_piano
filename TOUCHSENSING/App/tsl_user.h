...
#define CHANNEL_7_IO_MSK    (TSC_GROUP5_IO3)
#define CHANNEL_7_GRP_MSK   (TSC_GROUP5)
#define CHANNEL_7_SRC       (TSC_GROUP5_IDX) 
#define CHANNEL_7_DEST      (7) 

#define CHANNEL_8_IO_MSK    (TSC_GROUP3_IO3)
#define CHANNEL_8_GRP_MSK   (TSC_GROUP3)
#define CHANNEL_8_SRC       (TSC_GROUP3_IDX) 
#define CHANNEL_8_DEST      (8) 

#define CHANNEL_9_IO_MSK    (TSC_GROUP6_IO4)
...
#define CHANNEL_11_IO_MSK    (TSC_GROUP5_IO4)
#define CHANNEL_11_GRP_MSK   (TSC_GROUP5)
#define CHANNEL_11_SRC       (TSC_GROUP5_IDX) 
#define CHANNEL_11_DEST      (11) 

#define CHANNEL_12_IO_MSK    (TSC_GROUP4_IO2)
#define CHANNEL_12_GRP_MSK   (TSC_GROUP4)
#define CHANNEL_12_SRC       (TSC_GROUP4_IDX) 
...
#define BANK_2_MSK_CHANNELS   (CHANNEL_6_IO_MSK | CHANNEL_7_IO_MSK | CHANNEL_8_IO_MSK | CHANNEL_9_IO_MSK)
#define BANK_2_MSK_GROUPS     (CHANNEL_6_GRP_MSK | CHANNEL_7_GRP_MSK | CHANNEL_8_GRP_MSK | CHANNEL_9_GRP_MSK)

#define BANK_3_NBCHANNELS (3)
#define BANK_3_MSK_CHANNELS   (CHANNEL_10_IO_MSK | CHANNEL_11_IO_MSK | CHANNEL_12_IO_MSK)
#define BANK_3_MSK_GROUPS     (CHANNEL_10_GRP_MSK | CHANNEL_11_GRP_MSK | CHANNEL_12_GRP_MSK)
